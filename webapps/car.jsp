...
<head>
    ...
    .grid_box li a { display:block; color:#6f6f6f; background-position:10px -20px; 
        background-repeat: no-repeat; margin-top: 20px; min-height: 250px;
        padding-top:2em; font-size:20px; box-sizing:border-box;}
    .grid_tit { font-size:24px; font-weight:200; color:#000000; padding-top:50px; text-align:center;}
    .grid_com { padding-top: 14px; text-align:center;}
    </style>
</head>
<body>
    <div class="container">
                ...
                <div class="page_wrap">                    
                    <article class="grid">
                        <ul class="grid_box">
                            <li>
                                <a href="" class="item1">
                                    <img src="<%=path %>/image/car_niroev.png" width="410px">
                                    <h3 class="grid_tit">니로 EV</h3>
                                    <p class="grid_com">5,171 만원 ~</p>
                                </a>
                                <a href="" class="item2">
                                    <img src="<%=path %>/image/car_ev6gt.png" width="410px">
                                    <h3 class="grid_tit">EV6 GT</h3>
                                    <p class="grid_com">7,688 만원 ~</p>
                                </a>
                                <a href="" class="item3">
                                    <img src="<%=path %>/image/car_bongo3evpower.png" width="410px">
                            ...
                            <li>
                                <a href="" class="item4">
                                    <img src="<%=path %>/image/car_niroplus.png" width="410px">
                                    <h3 class="grid_tit">니로 플러스</h3>
                                    <p class="grid_com">4,600 만원 ~</p>
                                </a>
                                <a href="" class="item5">
                                    <img src="<%=path %>/image/car_bongo3-ev.png" width="410px">
                            ...
                            <li>
                                <a href="" class="item6">
                                    <img src="<%=path %>/image/car_ev6.png" width="410px">
                                    <h3 class="grid_tit">EV6</h3>
                                    <p class="grid_com">5,187 만원 ~</p>
                                </a>
                                <a href="" class="item7">
                                    <img src="<%=path %>/image/car_bongo3evfrozen.png" width="410px">
                ...
                <div class="page_wrap">                    
                    <article class="grid">
                        <ul class="grid_box">
                            <li>
                                <a href="" class="item1">
                                    <img src="<%=path %>/image/car_morning.png" width="410px">
                                    <h3 class="grid_tit">모닝</h3>
                                    <p class="grid_com">1,175 만원 ~</p>
                                </a>
                                <a href="" class="item2">
                                    <img src="<%=path %>/image/car_k3_gt.png" width="410px">
                                    <h3 class="grid_tit">K3 GT</h3>
                                    <p class="grid_com">2,775 만원 ~</p>
                                </a>
                                <a href="" class="item3">
                                    <img src="<%=path %>/image/car_stinger.png" width="410px">
                            ...
                            <li>
                                <a href="" class="item4">
                                    <img src="<%=path %>/image/car_ray.png" width="410px">
                                    <h3 class="grid_tit">레이</h3>
                                    <p class="grid_com">1,390 만원 ~</p>
                                </a>
                                <a href="" class="item5">
                                    <img src="<%=path %>/image/k5_s_agt.png" width="410px">
                                    <h3 class="grid_tit">K5</h3>
                                    <p class="grid_com">2,445 만원 ~</p>
                                </a>
                                <a href="" class="item6">
                                    <img src="<%=path %>/image/car_k9.png" width="410px">
                                    <h3 class="grid_tit">EV6</h3>
                            ...
                            <li>
                                <a href="" class="item7">
                                    <img src="<%=path %>/image/car_k3.png" width="410px">
                                    <h3 class="grid_tit">K3</h3>
                                    <p class="grid_com">1,785 만원 ~</p>
                                </a>
                                <a href="" class="item8">
                                    <img src="<%=path %>/image/car_k8.png" width="410px">
                ...
                <div class="page_wrap">                    
                    <article class="grid">
                        <ul class="grid_box">
                            <li>
                                <a href="" class="item1">
                                    <img src="<%=path %>/image/car_seltos.png" width="410px">
                                    <h3 class="grid_tit">셀토스</h3>
                                    <p class="grid_com">2,100 만원 ~</p>
                                </a>
                                <a href="" class="item2">
                                    <img src="<%=path %>/image/car_sorento.png" width="410px">
                                    <h3 class="grid_tit">쏘렌토</h3>
                                    <p class="grid_com">3,058 만원 ~</p>
                                </a>
                                <a href="" class="item3">
                                    <img src="<%=path %>/image/car_carnival_hilimousine.png" width="410px">
                            ...
                            <li>
                                <a href="" class="item4">
                                    <img src="<%=path %>/image/car_niro_hybrid.png" width="410px">
                                    <h3 class="grid_tit">니로</h3>
                                    <p class="grid_com">2,888 만원 ~</p>
                                </a>
                                <a href="" class="item5">
                                    <img src="<%=path %>/image/car_mohave.png" width="410px">
                            ...
                            <li>
                                <a href="" class="item6">
                                    <img src="<%=path %>/image/car_sportage.png" width="410px">
                                    <h3 class="grid_tit">스포티지</h3>
                                    <p class="grid_com">2,520 만원 ~</p>
                                </a>
                                <a href="" class="item7">
                                    <img src="<%=path %>/image/car_carnival.png" width="410px">
                ...
                <div class="page_wrap">                    
                    <article class="grid">
                        <ul class="grid_box">
                            <li>
                                <a href="" class="item1">
                                    <img src="<%=path %>/image/car_k8_taxi.png" width="410px">
                                    <h3 class="grid_tit">K8 택시</h3>
                                    <p class="grid_com">2,795 만원 ~</p>
                                </a>
                                <a href="" class="item2">
                                    <img src="<%=path %>/image/car_bongo3_dump.png" width="410px">
                                    <h3 class="grid_tit">봉고3 덤프</h3>
                                    <p class="grid_com">2,579 만원 ~</p>
                                </a>
                                <a href="" class="item3">
                                    <img src="<%=path %>/image/car_granbird.png" width="410px">
                            ...
                            <li>
                                <a href="" class="item4">
                                    <img src="<%=path %>/image/car_bongo3.png" width="410px">
                                    <h3 class="grid_tit">봉고3 트럭</h3>
                                    <p class="grid_com">1,815 만원 ~</p>
                                </a>
                                <a href="" class="item5">
                                    <img src="<%=path %>/image/car_bongo3pow.png" width="410px">
                            ...
                            <li>
                                <a href="" class="item6">
                                    <img src="<%=path %>/image/car_bongo3_frozen.png" width="410px">
                                    <h3 class="grid_tit">봉고3 탑차/윙바디/워크스루밴</h3>
                                    <p class="grid_com">2,566 만원 ~</p>
                                </a>
                                <a href="" class="item7">
                                    <img src="<%=path %>/image/car_bongo3_wide.png" width="410px">
