                    ...
                    <form name="modify_form" id="modify_form" action="member_modify_pro.jsp" method="post" onsubmit="return form_check(this)">
						<table class="table">
							<tbody>
								...
								<tr>
									<th><label for="phone" class="lb">전화번호</label></th>
									<td><input type="tel" name="phone" id="phone" maxlength="13" value="<%=phone %>" class="indata"></td>
								</tr>
								<tr>
								...
								<tr>
									...
									<td><input type="text" name="address" id="address" value="<%=address %>" class="indata"></td>
								</tr>
								<tr>
									<td colspan="2">
