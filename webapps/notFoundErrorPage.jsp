...
<style>
.vs { height:40vh; }
 .content { background-image: url("./image/top_career.jpg"); }
...
.title { text-align:center; width: 900px; height: 200px; margin: 0 auto; font-size: 4em; margin-top: 100px;}
#tb1, .msg { width:1800px; margin:0 auto; text-align:center; }
.btn { margin-top:20px; }
...
<div class="msg">
	...
	<img src="../image/404pages.jpg" alt="찾을 수 없는 페이지">
