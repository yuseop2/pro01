            ...
            <section class="page" id="page1">
                ...
                <div class="tb_wrap">
					<table class="table" id="tb1">
						<thead>
							<tr><th>연번</th><th>아이디</th><th>회원명</th><th>연락처</th><th>가입일</th><th>관리</th></tr>
						</thead>
						<tbody>
<%
...
%>
							<tr>
								...
								<td>								
									<% if(!kid.equals("admin")) { %>
									<a href='<%=path %>/admin/member_del.jsp?id=<%=kid %>' class="btn btn-primary" id="member_del">직권 탈퇴</a>
									<% } %>
								</td>
							</tr>
<%							
